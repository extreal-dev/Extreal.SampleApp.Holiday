...
namespace Extreal.SampleApp.Holiday.Controls.MultiplayHostControl
{
    public class MultiplayHost : DisposableBase
    {
        ...
        )
        {
            ...
            ngoHost.OnServerStarted
                .Subscribe(_ =>
                {
                    ...
                    ngoHost.RegisterMessageHandler(MessageName.EveryoneRequest.ToString(), EveryoneRequestMessageHandler);
                })
                .AddTo(disposables);
            ...
            ngoHost.OnServerStopping
                .Subscribe(_ =>
                {
                    ...
                    ngoHost.UnregisterMessageHandler(MessageName.EveryoneRequest.ToString());
                })
                .AddTo(disposables);
        }
        ...
        private void EveryoneRequestMessageHandler(ulong clientId, FastBufferReader messageStream)
        {
        ...
        private void SendEveryonePublicationToAllClientsIgnore(ulong ignoreClientId, Message message)
        {
            ...
            var clientIds = ngoHost.ConnectedClients
                ...
                .ToList();
            ngoHost.SendMessageToClients(clientIds, MessageName.EveryonePublication.ToString(), messageStream);
        }
    }
}
