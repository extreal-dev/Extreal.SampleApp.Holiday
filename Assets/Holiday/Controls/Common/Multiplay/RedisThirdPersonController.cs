...
#pragma warning disable
    ...
    public class RedisThirdPersonController : MonoBehaviour, IMultipayStrategy
    {
        ...
        {
            multiplayStrategy = new RedisMultiplayStrategy(gameObject, CinemachineCameraTarget, GroundLayers);
