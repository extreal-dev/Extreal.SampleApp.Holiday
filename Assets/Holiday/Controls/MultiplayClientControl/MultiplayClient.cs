...
namespace Extreal.SampleApp.Holiday.Controls.MultiplyClientControl
{
    public class MultiplayClient : DisposableBase
    {
        ...
        public MultiplayClient(NgoClient ngoClient, AssetHelper assetHelper, AppState appState)
        {
            ...
            this.ngoClient.OnConnected
                ...
                .Subscribe(_ =>
                {
                    ...
                    ngoClient.RegisterMessageHandler(MessageName.EveryonePublication.ToString(), EveryonePublicationMessageHandler);
        ...
        public void SendEveryoneRequest(Message message)
        {
            if (Logger.IsDebug())
            {
                Logger.LogDebug(
            ...
            ngoClient.SendMessage(MessageName.EveryoneRequest.ToString(), messageStream);
        }
        ...
        private void EveryonePublicationMessageHandler(ulong senderClientId, FastBufferReader messagePayload)
        {
