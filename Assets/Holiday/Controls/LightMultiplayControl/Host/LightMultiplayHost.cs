...
{
    public class LightMultiplayHost : DisposableBase
    {
        ...
        private static readonly ELogger Logger = LoggingManager.GetLogger(nameof(LightMultiplayHost));

        public LightMultiplayHost
        (
            NgoServer ngoHost,
