...
namespace Extreal.SampleApp.Holiday.Controls.LightMultiplyControl.Client
{
    public class LightMultiplayClientPresenter : StagePresenterBase
    {
        private readonly NgoClient ngoClient;
        private readonly AssetHelper assetHelper;
        private LightMultiplayClient multiplayClient;

        public LightMultiplayClientPresenter
        (
            NgoClient ngoClient,
        ...
        )
        {
            ...
            multiplayClient = new LightMultiplayClient(ngoClient, assetHelper, appState);
        ...
        {
            if (!appState.IsLightForCommunication || AppUtils.IsSpace(stageName))
            {
                return;
            }
